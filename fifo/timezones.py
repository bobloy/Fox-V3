...
def assemble_timezones():
    ...
    timezones["CHADT"] = timezone(
        "Pacific/Chatham"
    )  # Chatham Daylight Time (UTC+13:45)
    timezones["CHAST"] = timezone(
        "Pacific/Chatham"
    ...
    timezones["HADT"] = timezone(
        "Pacific/Honolulu"
    )  # Hawaii-Aleutian Daylight Time (UTC−09)
    timezones["HAEC"] = timezone(
        "Europe/Paris"
    )  # Heure Avancée d'Europe Centrale (CEST) (UTC+02)
    timezones["HAST"] = timezone(
        "Pacific/Honolulu"
    )  # Hawaii-Aleutian Standard Time (UTC−10)
    timezones["HKT"] = timezone("Asia/Hong_Kong")  # Hong Kong Time (UTC+08)
    timezones["HMT"] = timezone(
        "Indian/Kerguelen"
    ...
    timezones["NZDT"] = timezone(
        "Pacific/Auckland"
    )  # New Zealand Daylight Time (UTC+13)
    timezones["NZST"] = timezone(
        "Pacific/Auckland"
